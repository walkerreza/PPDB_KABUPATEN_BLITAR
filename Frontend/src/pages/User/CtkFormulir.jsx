            ...
            <main className="p-4 md:p-8">
              <Card className="p-6">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <PrintButton
                    className={`print:hidden ${pendaftaranData?.is_diterima !== 1 ? 'opacity-50 cursor-not-allowed' : ''}`}
                    onClick={handlePrint}
                    disabled={pendaftaranData?.is_diterima !== 1}
                  >
                    Cetak
                  </PrintButton>
                </div>
                ...
                <div className="bg-gray-200 rounded-lg p-4 max-h-[calc(100vh-250px)] overflow-y-auto">
                  ...
                  <div className="bg-gray-200 rounded-lg mx-auto">
                    ...
                    ) : pendaftaranData?.is_diterima !== 1 ? (
                      <div className="bg-white p-4 sm:p-8 mx-auto w-full max-w-4xl shadow-[0_0_10px_rgba(0,0,0,0.1)] rounded-sm min-h-[500px] flex items-center justify-center">
                        <div className="text-center">
                          <Typography variant="h3" className="mb-6 text-2xl sm:text-3xl" style={{ fontFamily: "'Times New Roman', Times, serif", fontWeight: 900 }}>
                            PEMBERITAHUAN!
                          </Typography>
                          <Typography variant="h5" className="mb-4 text-lg sm:text-xl" style={{ fontFamily: "'Times New Roman', Times, serif", fontWeight: 500, color: '#666' }}>
                            Mohon Tunggu
                          </Typography>
                          <Typography variant="h5" className="text-lg sm:text-xl" style={{ fontFamily: "'Times New Roman', Times, serif", fontWeight: 500, color: '#666' }}>
                            ...
                            <div className="w-32 h-40 border border-gray-300">
                              {fotoUrl ? (
                                ...
                                <div className="w-full h-full flex items-center justify-center bg-gray-100">
                                  <span className="text-gray-400">Foto 3x4</span>
                                </div>
                              )}
                            </div>
                            {/* QR Code */}
