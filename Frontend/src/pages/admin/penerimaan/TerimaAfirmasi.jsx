...
const TerimaAfirmasi = () => {
  const [isOpen, setIsOpen] = useState(window.innerWidth >= 768);
  const [isMobile, setIsMobile] = useState(window.innerWidth < 768);

  // Data dummy untuk contoh
  const data = [
    { id: 'A001', nama: 'John Doe', ttl: 'Jakarta, 15 Jan 2010', jk: 'L', asal_sekolah: 'SDN 1 Jakarta', alamat: 'Jl. Sudirman No. 1', nilai: '85.5', dokumen: 'Lengkap', jarak: 2.5, maps: 'Lihat', waktu: '2024-01-15 08:30', aksi: '' },
    { id: 'A002', nama: 'Jane Smith', ttl: 'Surabaya, 22 Mar 2010', jk: 'P', asal_sekolah: 'SDN 2 Surabaya', alamat: 'Jl. Thamrin No. 2', nilai: '90.0', dokumen: 'Lengkap', jarak: 1.8, maps: 'Lihat', waktu: '2024-01-15 09:15', aksi: '' },
    // ... data lainnya
  ];
          ...
          <div className={`flex-1 ${isOpen ? 'md:ml-64' : ''}`}>
            <main className="p-8">
              <Card className="p-6">
                ...
                <TableContainer 
                  title="Data Pendaftar Jalur Afirmasi"
